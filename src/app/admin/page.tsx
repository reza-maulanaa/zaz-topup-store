...
function StatCard({
  ...
  return (
    <div className="flex items-start justify-between border border-slate-200 bg-white p-6 shadow-sm">
      <div>
...
function UserAvatar({ name }: { name: string }) {
  const initials = name
    ...
    .toUpperCase();
  return (
    <div className="flex h-9 w-9 shrink-0 items-center justify-center bg-slate-100 text-xs font-bold text-slate-600">
      {initials}
    </div>
  );
}
  ...
  if (error)
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4">
        <div className="w-full max-w-sm border border-red-200 bg-red-50 p-6 text-center shadow-sm">
          ...
          <button
            ...
            className="mt-4 bg-red-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-red-700"
          >
            Coba Lagi
          </button>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
        ...
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div className="flex gap-2 self-start sm:self-auto">
            <button
              onClick={() => router.push("/")}
              className="flex items-center gap-2 border border-slate-200 bg-white px-5 py-2.5 text-sm font-semibold text-slate-700 shadow-sm transition hover:bg-slate-50"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 bg-slate-900 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-slate-700 hover:shadow"
            >
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
